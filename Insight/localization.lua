...
INSIGHT_SLASH_INSIGHT0		= "Insight Release 8 by Jerek Dain (www.JerekDain.com)";
INSIGHT_SLASH_INSIGHT1		= "List of Insight Commands:";
INSIGHT_SLASH_INSIGHT2		= "   /insight o - /insight options - Display options panel.";
-- INSIGHT_SLASH_INSIGHT3	= "   /rl - /reloadui - Reload UI.";
INSIGHT_SLASH_INSIGHT3		= "   /tnl - Display TNL info or send to chat. Type /tnl help for more info.";
INSIGHT_SLASH_INSIGHT98		= "Add \"help\" to the end of any command for more info.";
INSIGHT_SLASH_INSIGHT99		= "Scroll up to see more Insight options.";

-- ** BINDINGS TEXT ** --

BINDING_HEADER_INSIGHTPLAYERSIDEHEADER		= "Insight";
BINDING_NAME_INSIGHTOPTIONS					= "Open the options panel";
BINDING_NAME_INSIGHTPLAYERSIDEHEALTH		= "Toggle side health display";
BINDING_NAME_INSIGHTPLAYERSIDEMANA			= "Toggle side mana display";
BINDING_NAME_INSIGHTPLAYERSIDECHARGES		= "Toggle charges display";
BINDING_NAME_INSIGHTPLAYERSIDEMAXES			= "Toggle display maxes on the side";
BINDING_NAME_INSIGHTPLAYERSIDEMISSING		= "Toggle display missing amounts on the side";
BINDING_NAME_INSIGHTPLAYERSIDEHEALTHPER		= "Toggle side health as percent";
BINDING_NAME_INSIGHTPLAYERSIDEMANAPER		= "Toggle side mana as percent";
BINDING_NAME_INSIGHTEXP						= "Toggle display EXP";
BINDING_NAME_INSIGHTTNL						= "Toggle display TNL";
BINDING_NAME_INSIGHTBAREXP					= "Toggle EXP/TNL in bars";
BINDING_NAME_INSIGHTFORCEDECIMALS			= "Toggle always display decimals";
BINDING_NAME_INSIGHTAUTOHIDEEXP				= "Toggle EXP/TNL hiding on lvl 70s";
BINDING_NAME_INSIGHTCOLORPLAYERNAME			= "Toggle name coloration";
BINDING_NAME_INSIGHTCOLORPLAYERHEALTH		= "Toggle player health coloration";
BINDING_NAME_INSIGHTCOLORPLAYERMANA			= "Toggle player mana coloration";
BINDING_NAME_INSIGHTCOLORTARGETHEALTH		= "Toggle target health coloration";
BINDING_NAME_INSIGHTCOLORTARGETMANA			= "Toggle target mana coloration";
BINDING_NAME_INSIGHTCOLORPLAYERHEALTHBAR	= "Toggle player health bar coloration";
BINDING_NAME_INSIGHTCOLORTARGETHEALTHBAR	= "Toggle target health bar coloration";
